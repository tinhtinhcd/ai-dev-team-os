 ...
 * Falls back to posting in the default channel if no mapping exists
 * (creates a new top-level message; Slack threading requires thread_ts).
 */
 ...
 * Returns mapped thread if exists; otherwise returns default channel for new-thread posts.
 */
